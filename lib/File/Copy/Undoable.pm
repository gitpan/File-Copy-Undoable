...
This document describes version 0.06 of File::Copy::Undoable (from Perl distribution File-Copy-Undoable), released on 2014-12-05.
...
=item * B<rsync_opts> => I<array> (default: ["-a"])
